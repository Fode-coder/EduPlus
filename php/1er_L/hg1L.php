...
$sql = "SELECT * FROM documents_college WHERE niveau = '1el' AND matiere = 'hg' ORDER BY type_doc, date_ajout DESC";
...
<head>
    <meta charset="UTF-8">
    <title>Histoire-Géographie 1ère L - EduPlus</title>
   ...
   <?php include '../footer/head.php'; ?>
    ...
    <main class="documents-container">
        <div class="page-header">
            <h1><i class="fas fa-book-open"></i> Histoire-Géographie - Classe de 1<sup>ère</sup>L</h1>
            <div class="breadcrumb">
                <span>Accueil</span> > <span>Collège</span> > <span>1<sup>ère</sup>L</span> > <span class="active">HG</span>
            </div>
        </div>
