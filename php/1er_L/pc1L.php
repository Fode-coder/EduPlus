...
$sql = "SELECT * FROM documents_college WHERE niveau = '1el' AND matiere = 'pc' ORDER BY type_doc, date_ajout DESC";
...
<body>
    ...
    <main class="documents-container">
        <div class="page-header">
            <h1><i class="fas fa-book-open"></i> PC - Classe de 1<sup>ère</sup>L</h1>
            <div class="breadcrumb">
                <span>Accueil</span> > <span>Collège</span> > <span>1<sup>ère</sup>L</span> > <span class="active">PC</span>
            </div>
        </div>
