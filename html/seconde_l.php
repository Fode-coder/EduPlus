...
<head>
  ...
  <title>Cours de 2nd L | EduPlus</title>
  ...
  <main>
    ...
    <section class="intro">
      <div class="intro-content">
        <h2>Cours de <span>2<sup>nd</sup>L</span></h2>
    ...
    <section class="matieres">
      ...
      <div class="grid-matieres">
        <!-- Mathématiques -->
        <a href="../php/2nd_L/math2L.php" class="matiere-card matiere-maths">
        ...
        <!-- Français -->
        <a href="../php/2nd_L/francais2L.php" class="matiere-card matiere-francais">
          <div class="matiere-icon">
        ...
        <!-- Histoire-Géo -->
        <a href="../php/2nd_L/hg2L.php" class="matiere-card matiere-hg">
          <div class="matiere-icon">
        ...
        <!-- SVT -->
        <a href="../php/62nd_Le/svt2L.php" class="matiere-card matiere-svt">
          <div class="matiere-icon">
        ...
        <!-- Anglais -->
        <a href="../php/2nd_L/anglais2L.php" class="matiere-card matiere-anglais">
          <div class="matiere-icon">
