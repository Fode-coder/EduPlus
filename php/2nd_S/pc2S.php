...
$sql = "SELECT * FROM documents_college WHERE niveau = '2nds' AND matiere = 'pc' ORDER BY type_doc, date_ajout DESC";
   ...
   <?php include '../footer/head.php'; ?>
    ...
    <main class="documents-container">
        <div class="page-header">
            <h1><i class="fas fa-book-open"></i> PC - Classe de 2<sup>nd</sup>S</h1>
            <div class="breadcrumb">
                <span>Accueil</span> > <span>Collège</span> > <span>2<sup>nd</sup>S</span> > <span class="active">PC</span>
            </div>
        </div>
