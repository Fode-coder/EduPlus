...
<head>
  ...
  <title>Cours de 2nd S | EduPlus</title>
  ...
  <main>
    ...
    <section class="intro">
      <div class="intro-content">
        <h2>Cours de <span>2<sup>nd</sup>S</span></h2>
    ...
    <section class="matieres">
      ...
      <div class="grid-matieres">
        <!-- Mathématiques -->
        <a href="../php/2nd_S/math2S.php" class="matiere-card matiere-maths">
        ...
        <!-- science physique -->
        <a href="../php/2nd_S/pc2S.php" class="matiere-card matiere-maths">
          <div class="matiere-icon">
        ...
        <!-- Français -->
        <a href="../php/2nd_S/francais2S.php" class="matiere-card matiere-francais">
          <div class="matiere-icon">
        ...
        <!-- Histoire-Géo -->
        <a href="../php/2nd_S/hg2S.php" class="matiere-card matiere-hg">
          <div class="matiere-icon">
        ...
        <!-- SVT -->
        <a href="../php/2nd_S/svt2S.php" class="matiere-card matiere-svt">
          <div class="matiere-icon">
        ...
        <!-- Anglais -->
        <a href="../php/2nd_S/anglais2S.php" class="matiere-card matiere-anglais">
          <div class="matiere-icon">
