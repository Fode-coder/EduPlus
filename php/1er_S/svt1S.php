...
$sql = "SELECT * FROM documents_college WHERE niveau = '1es' AND matiere = 'svt' ORDER BY type_doc, date_ajout DESC";
...
<head>
    <meta charset="UTF-8">
    <title>SVT 1ère S- EduPlus</title>
...
<body>
    ...
    <main class="documents-container">
        <div class="page-header">
            <h1><i class="fas fa-book-open"></i> SVT - Classe de 1<sup>ère</sup>S</h1>
            <div class="breadcrumb">
                <span>Accueil</span> > <span>Collège</span> > <span>1<sup>ère</sup>S</span> > <span class="active">svt</span>
            </div>
        </div>
