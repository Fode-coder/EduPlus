...
<head>
    <meta charset="UTF-8">
    <title>Anglais 3e - EduPlus</title>
...
<body>
    ...
    <main class="documents-container">
        <div class="page-header">
            <h1><i class="fas fa-book-open"></i> Anglais - Classe de 3<sup>e</sup></h1>
            <div class="breadcrumb">
                <span>Accueil</span> > <span>Collège</span> > <span>3<sup>e</sup></span> > <span class="active">Anglais</span>
            </div>
        </div>
