...
$sql = "SELECT * FROM documents_college WHERE niveau = 'tl' AND matiere = 'pc' ORDER BY type_doc, date_ajout DESC";
...
<head>
    <meta charset="UTF-8">
    <title>PC Terminale L - EduPlus</title>
...
<body>
    ...
    <main class="documents-container">
        <div class="page-header">
            <h1><i class="fas fa-book-open"></i> PC - Classe de T<sup>le</sup>L</h1>
            <div class="breadcrumb">
                <span>Accueil</span> > <span>Collège</span> > <span>T<sup>le</sup>L</span> > <span class="active">PC</span>
            </div>
        </div>
