...
$sql = "SELECT * FROM documents_college WHERE niveau = '2ndl' AND matiere = 'hg' ORDER BY type_doc, date_ajout DESC";
...
<head>
    <meta charset="UTF-8">
    <title>Histoire-Géographie 2nd L - EduPlus</title>
...
<body>
    ...
    <main class="documents-container">
        <div class="page-header">
            <h1><i class="fas fa-book-open"></i> Histoire-Géographie - Classe de 2<sup>nd</sup>L</h1>
            <div class="breadcrumb">
                <span>Accueil</span> > <span>Collège</span> > <span>2<sup>nd</sup>L</span> > <span class="active">HG</span>
            </div>
        </div>
