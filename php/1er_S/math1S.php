...
$sql = "SELECT * FROM documents_college WHERE niveau = '1es' AND matiere = 'math' ORDER BY type_doc, date_ajout DESC";
...
<head>
    <meta charset="UTF-8">
    <title>Mathématique 1ère S - EduPlus</title>
...
<body>
    ...
    <main class="documents-container">
        <div class="page-header">ai
            <h1><i class="fas fa-book-open"></i> Mathématique - Classe de 1<sup>ère</sup>S</h1>
            <div class="breadcrumb">
                <span>Accueil</span> > <span>Collège</span> > <span>1<sup>ère</sup>S</span> > <span class="active">Mathématique</span>
            </div>
        </div>
