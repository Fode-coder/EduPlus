...
<head>
  ...
  <title>Cours de 3e | EduPlus</title>
  ...
  <main>
    ...
    <section class="intro">
      <div class="intro-content">
        <h2>Cours de <span>3<sup>e</sup></span></h2>
    ...
    <section class="matieres">
      ...
      <div class="grid-matieres">
        <!-- Mathématiques -->
        <a href="../php/3e/math3.php" class="matiere-card matiere-maths">
        ...
        <!-- Français -->
        <a href="../php/3e/francais3.php" class="matiere-card matiere-francais">
          <div class="matiere-icon">
        ...
        <!-- Histoire-Géo -->
        <a href="../php/3e/hg3.php" class="matiere-card matiere-hg">
          <div class="matiere-icon">
        ...
        <!-- SVT -->
        <a href="../php/3e/svt3.php" class="matiere-card matiere-svt">
          <div class="matiere-icon">
        ...
        <!-- Anglais -->
        <a href="../php/3e/anglais3.php" class="matiere-card matiere-anglais">
          <div class="matiere-icon">
