...
<head>
  ...
  <title>Cours de 2nd STEG | EduPlus</title>
  ...
  <main>
    ...
    <section class="intro">
      <div class="intro-content">
        <h2>Cours de <span>2<sup>nd</sup>STEG</span></h2>
    ...
    <section class="matieres">
      ...
      <div class="grid-matieres">
        <!-- Mathématiques -->
        <a href="../php/6e/math6.php" class="matiere-card matiere-maths">
        ...
        <!-- Français -->
        <a href="../php/6e/francais6.php" class="matiere-card matiere-francais">
          <div class="matiere-icon">
        ...
        <!-- Histoire-Géo -->
        <a href="../php/6e/hg6.php" class="matiere-card matiere-hg">
          <div class="matiere-icon">
        ...
        <!-- SVT -->
        <a href="../php/6e/svt6.php" class="matiere-card matiere-svt">
          <div class="matiere-icon">
        ...
        <!-- Anglais -->
        <a href="../php/6e/anglais6.php" class="matiere-card matiere-anglais">
          <div class="matiere-icon">
