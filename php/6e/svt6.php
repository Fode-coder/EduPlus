...
$sql = "SELECT * FROM documents_college WHERE niveau = '6e' AND matiere = 'svt' ORDER BY type_doc, date_ajout DESC";
...
<body>
    ...
    <main class="documents-container">
        <div class="page-header">
            <h1><i class="fas fa-book-open"></i> SVT - Classe de 6<sup>e</sup></h1>
            <div class="breadcrumb">
                <span>Accueil</span> > <span>Collège</span> > <span>6<sup>e</sup></span> > <span class="active">svt</span>
            </div>
        </div>
