...
$sql = "SELECT * FROM documents_college WHERE niveau = '6e' AND matiere = 'hg' ORDER BY type_doc, date_ajout DESC";
...
<head>
    <meta charset="UTF-8">
    <title>Histoire-Géographie 6e - EduPlus</title>
...
<body>
    ...
    <main class="documents-container">
        <div class="page-header">
            <h1><i class="fas fa-book-open"></i> Histoire-Géographie - Classe de 6<sup>e</sup></h1>
            <div class="breadcrumb">
                <span>Accueil</span> > <span>Collège</span> > <span>6<sup>e</sup></span> > <span class="active">HG</span>
            </div>
        </div>
