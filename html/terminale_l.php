...
<head>
  ...
  <title>Cours de Terminale L | EduPlus</title>
  ...
  <main>
    ...
    <section class="intro">
      <div class="intro-content">
        <h2>Cours de <span>T<sup>le</sup>L</span></h2>
    ...
    <section class="matieres">
      ...
      <div class="grid-matieres">
        <!-- Mathématiques -->
        <a href="../php/Ter_L/mathTL.php" class="matiere-card matiere-maths">
        ...
        <!-- Français -->
        <a href="../php/Ter_L/francaisTL.php" class="matiere-card matiere-francais">
          <div class="matiere-icon">
        ...
        <!-- Histoire-Géo -->
        <a href="../php/Ter_L/hgTL.php" class="matiere-card matiere-hg">
          <div class="matiere-icon">
        ...
        <!-- SVT -->
        <a href="../php/Ter_L/svtTL.php" class="matiere-card matiere-svt">
          <div class="matiere-icon">
        ...
        <!-- Anglais -->
        <a href="../php/Ter_L/anglaisTL.php" class="matiere-card matiere-anglais">
          <div class="matiere-icon">
