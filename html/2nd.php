...
<head>
    ...
    <title>Choix de la série - 2nd | EduPlus</title>
    ...
    <main>
        ...
        <section class="hero-section">
            <div class="hero-content">
                <h1>Orientation en <span>Seconde</span></h1>
        ...
        <section class="series-section">
            ...
            <div class="series-grid">
                <!-- Série Scientifique -->
                <a href="seconde_s.php" class="serie-card serie-scientifique">
                ...
                <!-- Série Littéraire -->
                <a href="seconde_l.php" class="serie-card serie-litteraire">
                    <div class="serie-icon">
                ...
                <!-- Série Gestion -->
                <a href="seconde_g.php" class="serie-card serie-gestion">
                    <div class="serie-icon">
