...
$sql = "SELECT * FROM documents_college WHERE niveau = '5e' AND matiere = 'hg' ORDER BY type_doc, date_ajout DESC";
...
<head>
    <meta charset="UTF-8">
    <title>Histoire-Géographie 5e - EduPlus</title>
    ...
    <main class="documents-container">
        <div class="page-header">
            ...
            <div class="breadcrumb">
                <span>Accueil</span> > <span>Collège</span> > <span>5<sup>e</sup></span> > <span class="active">HG</span>
            </div>
        </div>
