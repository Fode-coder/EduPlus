...
$sql = "SELECT * FROM documents_college WHERE niveau = '6e' AND matiere = 'anglais' ORDER BY type_doc, date_ajout DESC";
...
<head>
    <meta charset="UTF-8">
    <title>Anglais 6e - EduPlus</title>
...
<body>
    ...
    <main class="documents-container">
        <div class="page-header">
            <h1><i class="fas fa-book-open"></i> Anglais - Classe de 6<sup>e</sup></h1>
            <div class="breadcrumb">
                <span>Accueil</span> > <span>Collège</span> > <span>6<sup>e</sup></span> > <span class="active">Anglais</span>
            </div>
        </div>
