...
<head>
  ...
  <title>Cours de Terminale S | EduPlus</title>
  ...
  <main>
    ...
    <section class="intro">
      <div class="intro-content">
        <h2>Cours de <span>T<sup>le</sup>S</span></h2>
        <p class="subtitle">Programme complet conforme au cycle 3</p>
        <div class="decoration-line"></div>
      </div>
      <div class="intro-illustration">
        <img src="../images/6eme-illustration.svg" alt="Collégien en 6e" loading="lazy">
      </div>
    </section>
    ...
    <section class="matieres">
      ...
      <div class="grid-matieres">
        <!-- Mathématiques -->
        <a href="../php/Ter_S/mathTS.php" class="matiere-card matiere-maths">
        ...
        <a href="../php/Ter_S/pcTS.php" class="matiere-card matiere-maths">
          <div class="matiere-icon">
        ...
        <!-- Français -->
        <a href="../php/Ter_S/francaisTS.php" class="matiere-card matiere-francais">
          <div class="matiere-icon">
        ...
        <!-- Histoire-Géo -->
        <a href="../php/Ter_S/hgTS.php" class="matiere-card matiere-hg">
          <div class="matiere-icon">
        ...
        <!-- SVT -->
        <a href="../php/Ter_S/svtTS.php" class="matiere-card matiere-svt">
          <div class="matiere-icon">
        ...
        <!-- Anglais -->
        <a href="../php/Ter_S/anglaisTS.php" class="matiere-card matiere-anglais">
          <div class="matiere-icon">
