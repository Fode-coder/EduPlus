...
$sql = "SELECT * FROM documents_college WHERE niveau = '2nds' AND matiere = 'math' ORDER BY type_doc, date_ajout DESC";
...
<head>
    <meta charset="UTF-8">
    <title>Mathématique 2nd S - EduPlus</title>
...
<body>
    ...
    <main class="documents-container">
        <div class="page-header">ai
            <h1><i class="fas fa-book-open"></i> Mathématique - Classe de 2<sup>nd</sup>S</h1>
            <div class="breadcrumb">
                <span>Accueil</span> > <span>Collège</span> > <span>2<sup>nd</sup>S</span> > <span class="active">Mathématique</span>
            </div>
        </div>
