...
<head>
  ...
  <title>Cours de 1ère L | EduPlus</title>
  ...
  <main>
    ...
    <section class="intro">
      <div class="intro-content">
        <h2>Cours de <span>1<sup>ère</sup>L</span></h2>
    ...
    <section class="matieres">
      ...
      <div class="grid-matieres">
        <!-- Mathématiques -->
        <a href="../php/1er_L/math1L.php" class="matiere-card matiere-maths">
        ...
        <a href="../php/1er_L/pc1L.php" class="matiere-card matiere-maths">
          <div class="matiere-icon">
        ...
        <!-- Français -->
        <a href="../php/1er_L/francais1L.php" class="matiere-card matiere-francais">
          <div class="matiere-icon">
        ...
        <!-- Histoire-Géo -->
        <a href="../php/1er_L/hg1L.php" class="matiere-card matiere-hg">
          <div class="matiere-icon">
        ...
        <!-- SVT -->
        <a href="../php/1er_L/svt1L.php" class="matiere-card matiere-svt">
          <div class="matiere-icon">
        ...
        <!-- Anglais -->
        <a href="../php/1er_L/anglais1L.php" class="matiere-card matiere-anglais">
          <div class="matiere-icon">
