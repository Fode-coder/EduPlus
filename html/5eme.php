...
<head>
  ...
  <title>Cours de 5e | EduPlus</title>
  ...
  <main>
    ...
    <section class="intro">
      <div class="intro-content">
        <h2>Cours de <span>5<sup>e</sup></span></h2>
    ...
    <section class="matieres">
      ...
      <div class="grid-matieres">
        <!-- Mathématiques -->
        <a href="../php/5e/math5.php" class="matiere-card matiere-maths">
        ...
        <!-- Français -->
        <a href="../php/5e/francais5.php" class="matiere-card matiere-francais">
          <div class="matiere-icon">
        ...
        <!-- Histoire-Géo -->
        <a href="../php/5e/hg5.php" class="matiere-card matiere-hg">
          <div class="matiere-icon">
        ...
        <!-- SVT -->
        <a href="../php/5e/svt5.php" class="matiere-card matiere-svt">
          <div class="matiere-icon">
        ...
        <!-- Anglais -->
        <a href="../php/5e/anglais5.php" class="matiere-card matiere-anglais">
          <div class="matiere-icon">
