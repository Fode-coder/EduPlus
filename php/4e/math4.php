...
$sql = "SELECT * FROM documents_college WHERE niveau = '4e' AND matiere = 'math' ORDER BY type_doc, date_ajout DESC";
...
<body>
    ...
    <main class="documents-container">
        <div class="page-header">ai
            <h1><i class="fas fa-book-open"></i> Mathématique - Classe de 4<sup>e</sup></h1>
            <div class="breadcrumb">
                <span>Accueil</span> > <span>Collège</span> > <span>4<sup>e</sup></span> > <span class="active">Mathématique</span>
            </div>
        </div>
